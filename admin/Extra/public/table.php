...
<?php 
    ...
    if(isset($_POST['data_database'])){
        ...
        $query="INSERT INTO `posts`(`branchid`, `kindid`, `topic`, `shortinfo`, `longinfo`, `author`, `links`, `subtime`, `code_data`) VALUES (
        $branchid,$kindid,'{$title}','{$shortinfo}','{$information}','{$author}','{$links}','{$timer}','{$coded}')";
